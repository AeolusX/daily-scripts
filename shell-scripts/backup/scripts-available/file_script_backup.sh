...
# They ALL must be Full PATH
# for now only one archive is created, could add one archive per folder
################################################
# define TIMEOUT in minutes after which we consider the script as beeing stuck
TIMEOUT=60
